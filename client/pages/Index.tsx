  ...
  return (
    <div>
      ...
      <section className="relative">
        ...
        <svg
          className="absolute -right-20 top-8 -z-10 opacity-20"
          width="400"
          height="400"
          viewBox="0 0 400 400"
          fill="none"
        ...
        <div className="container py-24 md:py-36 text-white">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-white/90">{company.description}</p>
      ...
      <section className="container py-16 md:py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Plâtrerie, faux plafonds et petits travaux de rénovation avec une
            finition soignée.
          </p>
        </div>
        ...
        <div className="rounded-2xl bg-[hsl(var(--primary))] px-8 py-10 text-primary-foreground md:flex md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-white/90">
              Contactez-nous pour un devis gratuit et des conseils
              personnalisés.
            </p>
          </div>
          <a
